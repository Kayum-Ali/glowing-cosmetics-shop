            ...
            <div className="flex flex-col lg:flex-row md:flex-row container mx-auto gap-14 lg:py-16 py-3 md:py-14 px-5">
                <div className="flex-1">
                    ...
                    <div className="flex flex-wrap lg:gap-5 gap-2 mt-3">
                        ...
                        />
                        <img
                            onClick={() => setActiveIMG(product.hoverImg)}
                            className="lg:w-32 w-20 hover:border-2 hover:border-[#FFC1CC] rounded-lg"
                            src={product.hoverImg}
                            alt=""
                        />
                        <img
                            onClick={() => setActiveIMG(product.extraImg[0])}
                            className="lg:w-32 w-20  hover:border-2 hover:border-[#FFC1CC] rounded-lg"
                            src={product.extraImg[0]}
                            alt=""
                        />
                        <img
                            onClick={() => setActiveIMG(product.extraImg[1])}
                            className="lg:w-32 w-20  hover:border-2 hover:border-[#FFC1CC] rounded-lg"
                            src={product.extraImg[1]}
                            alt=""
                        />
                        <img
                            onClick={() => setActiveIMG(product.extraImg[2])}
                            className="lg:w-32 w-20  hover:border-2 hover:border-[#FFC1CC] rounded-lg"
                            src={product.extraImg[2]}
                            alt=""
                        />
                    </div>
                </div>
                ...
                <div className="flex-1 space-y-3">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center gap-10">
                            <h2 className="text-black font-bold w-20">
                                SKU :{" "}
                            </h2>
                            <p>{product.SKU}</p>
                        </div>
            ...
            <div className="text-center text-sm lg:text-xl container mx-auto ">
                <Tabs>
                    ...
                    <TabPanel className={`w-2/3 mx-auto`}>
                        <h2>
                            Achieve a flawless complexion with our Radiant Glow
                            Foundation. This lightweight, buildable formula
                            offers medium to full coverage, perfect for everyday
                            wear or special occasions. Infused with skin-loving
                            ingredients, it hydrates and nourishes while
